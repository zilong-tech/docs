...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Node是一个内部类，这里的key为键，value为值，next指向下一个元素，可以看出HashMap中的元素不是一个单纯的键值对，<strong>还包含下一个元素的引用（链表时使用）</strong>。</p><p>数据结构是数组 + 链表或者红黑树</p><p><strong>当hash冲突时候，以链表形式存在，如果链表长度大于8并且数组长度大于64时，转换成红黑树，长度小于6时再转换成链表。</strong></p><img src="https://gitee.com/zysspace/pic/raw/master/images/202112041719919.PNG" style="zoom:67%;"><h3 id="存储元素过程" tabindex="-1"><a class="header-anchor" href="#存储元素过程" aria-hidden="true">#</a> 存储元素过程</h3><p>1、计算出key的hash值</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>static final int hash(Object key) {
    int h;
