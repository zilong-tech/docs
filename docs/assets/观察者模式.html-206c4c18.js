...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行结果</p><blockquote><p>用户收到消息：第一条消息 用户收到消息：第一条消息 用户收到消息：第二个消息</p></blockquote><p>可以看到，ConcreteSubject 维护了一个订阅关系，在通过notifyObservers 方法通知订阅者之后，观察者都获取到消息从而处理自己的业务逻辑。如果有新的业务添加进来，我们也只需要创建一个新的订阅者，并且维护到observers 容器中即可，也符合我们的开闭原则。</p><p>上面代码依赖关系</p><p><img src="https://gitee.com/zysspace/pic/raw/master/images/202112012314871.png" alt=""></p><h3 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h3><p>观察者模式是围绕了<strong>解耦</strong>的思想来写的，观察者模式作为行为型设计模式，主要也是为了不同的业务行为的代码<strong>解耦</strong>。</p><p>合理的使用设计模式可以使代码结构更加清晰，同时还能满足不同的小模块符合单一职责，以及开闭原则，提高代码的可扩展性，维护成本低的特点。</p>`,49),c=[l];function t(d,p){return s(),a("div",null,c)}const o=n(i,[["render",t],["__file","观察者模式.html.vue"]]);export{o as default};
