...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://gitee.com/zysspace/pic/raw/master/images/202205031651985.png" alt=""></p><h4 id="获取token-key" tabindex="-1"><a class="header-anchor" href="#获取token-key" aria-hidden="true">#</a> 获取token_key</h4><p><img src="https://gitee.com/zysspace/pic/raw/master/images/202205031652273.png" alt=""></p><h4 id="测试携带token访问资源" tabindex="-1"><a class="header-anchor" href="#测试携带token访问资源" aria-hidden="true">#</a> 测试携带token访问资源</h4><p><img src="https://gitee.com/zysspace/pic/raw/master/images/202205031656594.png" alt=""></p><p>也可以请求头配置Authorization</p><p>​ <img src="https://note.youdao.com/yws/public/resource/7b3179e6fa5d39fb758bb4677fb7e2df/xmlnote/F59CE2C295394F0C806CAE038C520E7E/16192" alt="0"></p><h4 id="校验token" tabindex="-1"><a class="header-anchor" href="#校验token" aria-hidden="true">#</a> 校验token</h4><p><img src="https://gitee.com/zysspace/pic/raw/master/images/202205031658873.png" alt=""></p><h3 id="配置网关服务" tabindex="-1"><a class="header-anchor" href="#配置网关服务" aria-hidden="true">#</a> 配置网关服务</h3><p>主要流程：</p><p>网关在启动时候，调用http://auth/oauth/token_key 获取公钥</p><p>1.过滤不需要认证的url,比如/oauth/**</p><ol start="2"><li>获取token ：从请求头中解析 Authorization value: bearer xxxxxxx 或者从请求参数中解析 access_token</li><li>校验token ：拿到token后，通过公钥（需要从授权服务获取公钥）校验 ， 校验失败或超时抛出异常</li><li>校验通过后，从token中获取的用户登录信息存储到请求头中</li></ol><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">server</span><span class="token punctuation">:</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">JwtUtils</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="获取token" tabindex="-1"><a class="header-anchor" href="#获取token" aria-hidden="true">#</a> 获取token</h4><p>网关的端口是8888</p><p><img src="http://rpumme6gd.hb-bkt.clouddn.com/202302152044421.png" alt=""></p><h4 id="登录" tabindex="-1"><a class="header-anchor" href="#登录" aria-hidden="true">#</a> 登录</h4><p><img src="https://gitee.com/zysspace/pic/raw/master/images/202205031750723.png" alt=""></p><h4 id="使用token" tabindex="-1"><a class="header-anchor" href="#使用token" aria-hidden="true">#</a> 使用token</h4><p><img src="https://gitee.com/zysspace/pic/raw/master/images/202205031850573.png" alt=""></p><h3 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h3><p>以上就是在网关中整合授权服务实现单点登录，希望对大家有帮助。</p>`,118),c=[p];function o(i,l){return s(),a("div",null,c)}const r=n(t,[["render",o],["__file","Spring Cloud 单点登录.html.vue"]]);export{r as default};
